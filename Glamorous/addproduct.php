...
<?php 
  ...
  if(isset($_POST["post"])){
    ...
    $sql = "INSERT INTO product(image,name,o_price,n_price,brand,description1,description2,description3,Gender,category,stock)
          VALUES('$img', '$name', '$oprice', '$nprice', '$brand', '$des1', '$des2', '$des3', '$gender', '$cat', '$stock')";
...
?>
<head>
  <title>Glamorous | Add Product</title>
</head>
<body>
    ...
    <form method="POST">
      <div class="row">
        <div class="col-sm">
          ...
          <p style="margin-bottom: 0;">Example: product//Panjabi//panjabi1.jpg</p>
        </div>
        <div class="col-sm">
