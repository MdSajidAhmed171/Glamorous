...
<!-- Navbar Starts -->
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	 <div class="container">
	  <a class="navbar-brand" href="index.php">Glamorous Store</a>
	    ...
	    <ul class="navbar-nav ml-auto">
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          <a class="dropdown-item nav-color" href="selected.php?brands=<?php echo "Ectasy"; ?>">Ectasy</a>
	          <a class="dropdown-item nav-color" href="selected.php?brands=<?php echo "Freeland"; ?>">Freeland</a>
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          <a class="dropdown-item nav-color" href="selected.php?Gender=<?php echo "Male"; ?>">Men</a>
	          <a class="dropdown-item nav-color" href="selected.php?Gender=<?php echo "Female"; ?>">Women</a>
	          <div class="dropdown-divider"></div>
	          <a class="dropdown-item nav-color" href="all.php">All</a>
	        </div>
	      </li>
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Sharee"; ?>">Sharee</a>
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Shirt"; ?>">Shirt</a>
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Panjabi"; ?>">Panjabi</a>
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Shoes"; ?>">Shoes</a>
	          <div class="dropdown-divider"></div>
	          <a class="dropdown-item nav-color" href="all.php">All</a>
	        </div>
	      </li>
